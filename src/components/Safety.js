...
export default function Safety() {
    ...
    const context = [
        { name: "Artykuł 1", link: "http://skoda-safety.wp.pl/artykul/czy-male-i-nowoczesne-auta-sa-bezpieczniejsze-niz-wieksze-i-starsze", context: "Zastanawiasz się nad pierwszym autem i chciałbyś, żeby było bezpieczne? A może chcesz dowiedzieć się o nowinkach motoryzacyjnych. To jest artykuł, w którym są poruszane najważniejsze kwestie bezpieczeństwa auta od reflektorów po nowoczesne systemy wspomagania kierowcy."},
